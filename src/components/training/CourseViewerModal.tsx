        ...
        >
            ...
            >
                ...
                <div className="flex justify-between items-center p-6 border-b border-white/5">
                    <div>
                        <h2 id="course-viewer-title" className="text-xl font-bold text-white">{course.title}</h2>
                ...
                >
                    <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-transparent to-transparent z-10 opacity-60 group-hover:opacity-40 transition-opacity" aria-hidden="true"></div>
                    ...
                    <div className="relative z-20 text-center">
                        ...
                        >
                            <PlayCircle size={40} className="text-white fill-white/20" aria-hidden="true" />
                        </button>
                ...
                <div className="p-8 overflow-y-auto">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4" role="list" aria-label="Course resources">
                        <button
                        ...
                        >
                            <div className="w-10 h-10 rounded bg-blue-500/10 flex items-center justify-center text-blue-400 font-bold" aria-hidden="true">
                                PDF
                            </div>
                            <div>
                        ...
                        >
                            <div className="w-10 h-10 rounded bg-slate-700/30 flex items-center justify-center text-slate-500 font-bold" aria-hidden="true">
                                <Lock size={16} />
                            </div>
                            <div>
                                ...
                                <div className="text-xs text-slate-600">Locked - Complete video to unlock</div>
                            </div>
                        </div>
                    </div>
                </div>
