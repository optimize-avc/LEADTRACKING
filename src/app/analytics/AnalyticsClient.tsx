...
import {
    TrendingUp, TrendingDown, Target, Phone,
    ...
    useEffect(() => {
        const loadForecast = async () => {
            if (!user) {
                ...
                const mockLeads = [
                    { value: 50000, status: 'Negotiation', companyName: 'Demo Corp', contactName: 'Alex Demo', email: 'alex@demo.com', id: '1', ownerId: 'demo', createdAt: Date.now(), statusUpdatedAt: Date.now() },
                    { value: 25000, status: 'Proposal', companyName: 'Test Inc', contactName: 'Sarah Test', email: 'sarah@test.com', id: '2', ownerId: 'demo', createdAt: Date.now(), statusUpdatedAt: Date.now() },
                    { value: 15000, status: 'Qualified', companyName: 'Cloud Co', contactName: 'Mike Cloud', email: 'mike@cloud.com', id: '3', ownerId: 'demo', createdAt: Date.now(), statusUpdatedAt: Date.now() }
                ] as any[]; // Using any[] temporarily for mock lead shape
