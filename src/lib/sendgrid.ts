...
export async function sendWelcomeEmail(
    ...
    const displayName = data.userName || data.recipientEmail.split('@')[0];
    ...
    const msg = {
        ...
        subject: `Welcome to SalesTracker AI! 🚀`,
        html: `
<!DOCTYPE html>
<html>
<head>
...
<body style="margin: 0; padding: 0; font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; background-color: #0f172a;">
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="background-color: #0f172a; padding: 40px 20px;">
                ...
                <table role="presentation" width="600" cellspacing="0" cellpadding="0" style="background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); border-radius: 16px; border: 1px solid rgba(148, 163, 184, 0.1); overflow: hidden;">
                    ...
                    <tr>
                        <td style="padding: 20px 40px;">
                            ...
                            <p style="color: #94a3b8; font-size: 16px; line-height: 1.6; margin: 0 0 24px; text-align: center;">
                                Your journey to sales excellence starts now. We're thrilled to have you on board!
                            </p>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top: 24px;">
                                <tr>
                                    <td style="padding: 20px; background: rgba(139, 92, 246, 0.1); border-radius: 12px; border: 1px solid rgba(139, 92, 246, 0.2);">
                                        <p style="color: #f1f5f9; font-size: 16px; font-weight: 600; margin: 0 0 16px;">
                                            🚀 Quick Start Guide
                                        </p>
                                        <table role="presentation" width="100%" cellspacing="0" cellpadding="0">
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="display: inline-block; width: 24px; height: 24px; background: #8b5cf6; border-radius: 50%; text-align: center; line-height: 24px; color: white; font-size: 12px; font-weight: bold; margin-right: 12px;">1</span>
                                                    <span style="color: #94a3b8; font-size: 14px;">Complete the onboarding wizard</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="display: inline-block; width: 24px; height: 24px; background: #8b5cf6; border-radius: 50%; text-align: center; line-height: 24px; color: white; font-size: 12px; font-weight: bold; margin-right: 12px;">2</span>
                                                    <span style="color: #94a3b8; font-size: 14px;">Add your first lead to the pipeline</span>
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="padding: 8px 0;">
                                                    <span style="display: inline-block; width: 24px; height: 24px; background: #8b5cf6; border-radius: 50%; text-align: center; line-height: 24px; color: white; font-size: 12px; font-weight: bold; margin-right: 12px;">3</span>
                                                    <span style="color: #94a3b8; font-size: 14px;">Try the AI-powered training simulations</span>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
                            ...
                            <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="margin-top: 24px;">
                                <tr>
                                    <td style="padding: 16px; background: rgba(59, 130, 246, 0.1); border-radius: 12px; border: 1px solid rgba(59, 130, 246, 0.2);">
                                        <p style="color: #94a3b8; font-size: 14px; margin: 0 0 12px;">
                                            <strong style="color: #f1f5f9;">What you can do with SalesTracker AI:</strong>
                                        </p>
                                        <ul style="color: #94a3b8; font-size: 14px; margin: 0; padding-left: 20px; line-height: 1.8;">
                                            <li>Track leads through your sales pipeline</li>
                                            <li>Get AI-powered insights and recommendations</li>
                                            <li>Practice objection handling with AI simulations</li>
                                            <li>View real-time analytics and forecasts</li>
                                            <li>Connect your team with Discord notifications</li>
                                        </ul>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td style="padding: 30px 40px; border-top: 1px solid rgba(148, 163, 184, 0.1);">
                            <p style="color: #94a3b8; font-size: 14px; margin: 0 0 8px; text-align: center;">
                                Need help? Visit our <a href="${APP_URL}/help" style="color: #8b5cf6;">Help Center</a>
                            </p>
                            <p style="color: #64748b; font-size: 12px; margin: 0; text-align: center;">
        ...
        `,
        text: `Welcome to SalesTracker AI, ${displayName}!\n\nYour journey to sales excellence starts now.\n\nQuick Start Guide:\n1. Complete the onboarding wizard\n2. Add your first lead to the pipeline\n3. Try the AI-powered training simulations\n\nGet started: ${APP_URL}\n\nNeed help? Visit our Help Center: ${APP_URL}/help\n\n© ${new Date().getFullYear()} SalesTracker AI. All rights reserved.`,
    };
