...
function InviteAcceptContent() {
  ...
  const fetchInvite = async () => {
    try {
      const response = await fetch(`/api/team/invite?company=${companyId}&invite=${inviteId}`);
        ...
        <GlassCard className="p-8">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-slate-400">
              <strong className="text-white">{invite.invitedByName}</strong> invited you to join
            </p>
          ...
          <div className="flex items-center justify-center gap-3 p-4 bg-slate-800/50 rounded-xl mb-6">
            <div className={`w-10 h-10 rounded-lg bg-slate-700 flex items-center justify-center ${roleConfig.color}`}>
            ...
            <div className="space-y-4">
              <div className="p-4 bg-amber-500/10 border border-amber-500/30 rounded-lg">
                <p className="text-sm text-amber-400">
                  You&apos;re already a member of another organization. Accepting this invitation will switch you to the new company.
                </p>
              </div>
