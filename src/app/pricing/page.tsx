    ...
    return (
        <div className="p-8 min-h-screen">
            <header className="mb-16 text-center max-w-2xl mx-auto">
                ...
                >
                    Professional Plans for <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-400 to-violet-400">High-Stake Closers</span>
                </motion.h1>
                <p className="text-slate-400 text-lg">
                    Scale your sales intelligence with industrial-grade AI and advanced deal wargaming.
                </p>
            </header>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto mb-20">
                {PRICING_TIERS.map((tier, idx) => (
                    ...
                    >
                        <GlassCard className={`relative h-full flex flex-col p-8 border-t-4 ${tier.color === 'blue' ? 'border-t-blue-500' :
                                tier.color === 'amber' ? 'border-t-amber-500 shadow-[0_0_20px_rgba(245,158,11,0.1)]' :
                                    'border-t-purple-500'
                            }`}>
                            {tier.popular && (
                            ...
                            <div className="mb-6">
                                ...
                                {tier.price !== 'Contact' && <span className="text-slate-500 ml-2">/month</span>}
                            </div>
            ...
            <footer className="text-center text-slate-500 text-sm max-w-xl mx-auto border-t border-white/5 pt-12">
                ...
                <a href="mailto:sales@salestracker-ai.com" className="text-indigo-400 hover:underline font-medium mt-2 block">
